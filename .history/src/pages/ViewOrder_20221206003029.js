        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    <div onChange={(e) =>{setOrderStatus(e.target.value)}} >
                        ...
                        <input type="radio" value="Completed" name="rejected" checked={onUpdateStatus(singleOrder.status = "REJECTED")}></input>
                        <input type="radio" value="Canceled" name="rejected" checked={onUpdateStatus(singleOrder.status = "REJECTED")}></input>
                        <input type="radio" value="Canceled" name="rejected" checked={onUpdateStatus(singleOrder.status = "REJECTED")}></input>
