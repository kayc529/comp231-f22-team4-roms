    ...
    <div className='control-main'>
        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                ...
                <div key={`inline-radio`} className="mb-3" onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} defaultChecked={orderStatus}>
                    <Form.Check inline type={"radio"} label={"Accept"} id={`inline-radio-1`}value="ACCEPTED" name="radioStatus"/>
                    <Form.Check inline type={"radio"} label={"Reject"} id={`inline-radio-2`} value="REJECTED" name="radioStatus" />
                    <Form.Check type={"radio"} label={"Reject"} id={"Comp"} value="REJECTED" name="radioStatus" />
                    <Form.Check type={"radio"} label={"Reject"} id={"Reject"} value="REJECTED" name="radioStatus" />
                    <Form.Check type={"radio"}label={"Reject"} id={"Reject"} value="REJECTED" name="radioStatus"/>
