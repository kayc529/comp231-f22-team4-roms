        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    <div onChange={(e) =>onUpdateStatus(singleOrder, e.target.value) } >
                        ...
                        Reject <input type="radio" value="REJECTED" name="radioStatus" checked={onUpdateStatus("REJECTED")}></input>
                        Completed <input type="radio" value="COMPLETED" name="radioStatus" checked={onUpdateStatus("COMPLETED")}></input>
                        Cancel <input type="radio" value="CANCELED" name="radioStatus" checked={onUpdateStatus("CANCELED")}></input>
                        Pending <input type="radio" value="PENDING" name="radioStatus" checked={onUpdateStatus("PENDING")}></input>
