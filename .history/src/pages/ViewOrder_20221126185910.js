...
const ViewOrder = () =>{
    ...
    useEffect(()=> {
            ...
            const calTotal = async () =>{
                let subTotal = orderItem[0].quantity * orderItem[0].menuItem.price;
            ...
            {
                let totalPrice = 0;
                let subTotal = orderItem[i].quantity * orderItem[i].menuItem.price;
                console.log(subTotal);

                 totalPrice = await totalPrice + subTotal;
                console.log(total)
                setTotal(total);
            }
        }
