...
const ManageOrder =()=>{
    ...
    console.log(moment("today" + new Date()).format('ll'));
    console.log(moment(orderData.createdAt).format('ll'))
    return (
            ...
            <Table striped bordered hover variant="light">
                ...
                {orderData.filter((order) => {
                    if (searchKeyword.length ===0 || filterState==="all"){
                        ...
                        if (moment(new Date()).format('ll') == moment(order.createdAt).format('ll'))
                            {
                        return order;
                        }
                    }
