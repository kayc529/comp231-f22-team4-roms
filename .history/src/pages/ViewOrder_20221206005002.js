        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    {/* <div onChange={(e) =>{setOrderStatus(e.target.value)}} > */}
                        ...
                        Reject <input type="radio" value="REJECTED" name="radioStatus" checked={onUpdateStatus(singleOrder, orderStatus)}></input>
                        Completed <input type="radio" value="COMPLETED" name="radioStatus" checked={onUpdateStatus(singleOrder, orderStatus)}></input>
                        Cancel <input type="radio" value="CANCELED" name="radioStatus" checked={onUpdateStatus(singleOrder, orderStatus)}></input>
                        Pending <input type="radio" value="PENDING" name="radioStatus" checked={onUpdateStatus(singleOrder, orderStatus)}></input>
