    ...
    <div className='control-main'>
        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                ...
                Accept  <input type="radio" value="ACCEPTED" name="radioStatus" Checked={orderStatus}
                    onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} /> 
                Reject <input type="radio" value="REJECTED" name="radioStatus" Checked={orderStatus}
                    onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} />
                Completed <input type="radio" value="COMPLETED" name="radioStatus" Checked={orderStatus}
                    onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} />
                Cancel <input type="radio" value="CANCELED" name="radioStatus" Checked={orderStatus}
                    onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} />
                Pending <input type="radio" value="PENDING" name="radioStatus" Checked={orderStatus}
