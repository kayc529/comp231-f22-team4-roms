        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    <div onChange={(e) =>{setOrderStatus(e.target.value)}} >
                        ...
                        <input type="radio" value="Completed" name="completed" checked={onUpdateStatus(singleOrder, singleOrder.status = "COMPLETED")}></input>
                        <input type="radio" value="Canceled" name="canceled" checked={onUpdateStatus(singleOrder,singleOrder.status = "CANCELED")}></input>
                        <input type="radio" value="Pending" name="pending" checked={onUpdateStatus(singleOrder,singleOrder.status = "PENDING")}></input>
