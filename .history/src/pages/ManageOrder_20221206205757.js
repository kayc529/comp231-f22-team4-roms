...
const ManageOrder =()=>{
    ...
    return (
        <div className='control-main'>
            ...
            <DropdownButton id="dropdown-basic-button" title="Filter orders" value={filterState}
                onSelect={(e)=> setFilterState(e.target.value)}>
      <Dropdown.Item value="all">All Orders</Dropdown.Item>
      <Dropdown.Item value="today">Today's Orders </Dropdown.Item>
