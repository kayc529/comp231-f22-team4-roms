    ...
    <div className='control-main'>
        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                ...
                <div onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} defaultChecked={orderStatus}>
                    <Form.Check inline type={"radio"} label={"Accept"} id={"Accept"}value="ACCEPTED" name="radioStatus"/>
                    <Form.Check inline type={"radio"} label={"Reject"} id={"Reject"} value="REJECTED" name="radioStatus" />
                    <Form.Check inline type={"radio"} label={"Reject"} id={"Complete"} value="REJECTED" name="radioStatus" />
                    <Form.Check inline type={"radio"} label={"Reject"} id={"Cancel"} value="REJECTED" name="radioStatus" />
                    <Form.Check inline type={"radio"}label={"Reject"} id={"Pending"} value="REJECTED" name="radioStatus"/>
