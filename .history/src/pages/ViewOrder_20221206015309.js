        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                ...
                Pending <input type="radio" value="PENDING" name="radioStatus" />
                  ...
                  <ButtonToolbar>
    <ToggleButtonGroup type="radio" name="options" defaultValue={singleOrder.status} onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} >
      <ToggleButton value={"ACCEPTED"}>Accept</ToggleButton>
      <ToggleButton value={"REJECTED"}>Reject</ToggleButton>
      <ToggleButton value={"COMPLETED"}>Complete</ToggleButton>
      <ToggleButton value={"CANCELED"}>Cancel</ToggleButton>
