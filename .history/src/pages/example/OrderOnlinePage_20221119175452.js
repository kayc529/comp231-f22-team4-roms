            ...
            <table border="1">
                ...
                <tr>
                    <td align="center">
                        ...
                        />
                        &nbsp;&nbsp;<button onClick="" style={{border:'none', borderRadius:'12px', backgroundColor:'#04AA6D', color:'white', margin:'4px 2px', height:'30px', width:'50px'}}>+ Add</button> <button onClick="" style={{border:'none', borderRadius:'12px', backgroundColor:'red', color:'white', margin:'4px 2px', height:'30px', width:'70px'}}>- Remove</button>
                    </td>
                    <td align="center">
