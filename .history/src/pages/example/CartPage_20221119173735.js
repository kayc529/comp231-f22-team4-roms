    ...
    return (
      <div className="container">
        <div className="row">
            ...
            <hr></hr>
            <div className="col-12" align="center" style={{backgroundColor:'#03A9F4', color:'white', fontSize:'20px'}}><b>Select Pick-up Time (For Take-away Customers only)</b></div>
            ...
            <div className="col-12">&nbsp;</div>
            <div className="col-12">&nbsp;</div>
            <div className="col-12" align="center" style={{backgroundColor:'#00E5FF', color:'white', fontSize:'20px'}}><b>Select Dine-in Time (For Dine-in Customers only)</b></div>
            <div className="col-12">&nbsp;</div>
            <div className="col-12" align="center">
                <input type="radio" value="20" name="pick-up" />&nbsp;&nbsp;<b>In 20 minutes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>  
                <input type="radio" value="30" name="pick-up" />&nbsp;&nbsp;<b>In 30 minutes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>
