        ...
        <div className="row">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td align="center">
                        <button onClick="" style={{border:'none', borderRadius:'12px', backgroundColor:'#04AA6D', color:'white', margin:'4px 2px', height:'30px', width:'100px'}}> Add </button>
                    </td>
                    <td>
                        <button onClick="" style={{border:'none', borderRadius:'12px', backgroundColor:'red', color:'white', margin:'4px 2px', height:'30px', width:'100px'}}> Remove </button>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <button onClick="" style={{border:'none', borderRadius:'12px', backgroundColor:'#04AA6D', color:'red', margin:'4px 2px', height:'30px', width:'100px'}}> Remove </button>
                    </td>
                </tr>
                <tr><td><hr></hr></td><td><hr></hr></td><td><hr></hr></td></tr>
                <tr>
