            ...
            <table border="1">
                ...
                <tr>
                    <td align="center">
                        ...
                        />
                        &nbsp;&nbsp;<button onClick="" style={{border:'none', borderRadius:'12px', backgroundColor:'#04AA6D', color:'white', margin:'4px 2px', height:'45px', width:'100px'}}> + </button><button onClick=""> - </button>
                    </td>
                    <td align="center">
