    ...
    <div className='control-main'>
        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                ...
                Accept  <input type="radio" value="ACCEPTED" name="radioStatus" defaultChecked={orderStatus==="ACCEPTED"}
                    /> 
                Reject <input type="radio" value="REJECTED" name="radioStatus" defaultChecked={orderStatus==="ACCEPTED"}
                     />
                Completed <input type="radio" value="COMPLETED" name="radioStatus" defaultChecked={orderStatus==="ACCEPTED"}
                     />
                Cancel <input type="radio" value="CANCELED" name="radioStatus" defaultChecked={orderStatus==="ACCEPTED"}
                     />
                Pending <input type="radio" value="PENDING" name="radioStatus" defaultChecked={orderStatus==="ACCEPTED"}/>
