            ...
            <Table striped bordered hover variant="light">
                ...
                <tbody>   
                    {orderData.filter((order) => {
                        ...
                        else if (filterState == "today" && moment(new Date()).isSame(moment(order.createdAt)), 'day') {
                        ...
                        else if (filterState == "past" && moment(new Date()).isAfter(moment(order.createdAt)), 'day') {
