    ...
    <div className='control-main'>
        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    <div onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} defaultChecked="" >
                        
                Accept  <input type="radio" value="ACCEPTED" name="radioStatus" defaultChecked={singleOrder.status}
                    /> 
                Reject <input type="radio" value="REJECTED" name="radioStatus" defaultChecked={singleOrder.status}
                     />
                Completed <input type="radio" value="COMPLETED" name="radioStatus" defaultChecked={singleOrder.status}
                     />
                Cancel <input type="radio" value="CANCELED" name="radioStatus" defaultChecked={singleOrder.status}
                     />
                Pending <input type="radio" value="PENDING" name="radioStatus" defaultChecked={singleOrder.status}/>
