...
const ViewOrder = () =>{
    ...
    useEffect(()=>{
        ...
        const fetchData = async () =>{
            ...
            console.log(resultItemtData[0].menuItem.name)

            setSingleOrder(resultData);
            for (let i = 0; i < resultItemtData.length; i++) {
                if (resultItemtData[i].menuItem.name == null) {
                    resultItemtData.menuItem.name = "Empty";
