        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    <div onChange={(e) =>{setOrderStatus(e.target.value)}} >
                        ...
                        Accept  <input type="radioStatus" value="Accepted" name="accepted" checked={onUpdateStatus(singleOrder, singleOrder.status = "ACCEPTED")}/> 
                        Reject <input type="radioStatus" value="Rejected" name="rejected" checked={onUpdateStatus(singleOrder, singleOrder.status = "REJECTED")}></input>
                        Completed <input type="radioStatus" value="Completed" name="completed" checked={onUpdateStatus(singleOrder, singleOrder.status = "COMPLETED")}></input>
                        Cancel <input type="radioStatus" value="Canceled" name="canceled" checked={onUpdateStatus(singleOrder,singleOrder.status = "CANCELED")}></input>
                        Pending <input type="radioStatus" value="Pending" name="pending" checked={onUpdateStatus(singleOrder,singleOrder.status = "PENDING")}></input>
