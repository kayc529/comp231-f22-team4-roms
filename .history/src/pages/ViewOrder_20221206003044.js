        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    <div onChange={(e) =>{setOrderStatus(e.target.value)}} >
                        ...
                        <input type="radio" value="Accepted" name="accepted" checked={onUpdateStatus(singleOrder.status = "ACCEPTED")}></input>
                        <input type="radio" value="Rejected" name="rejected" checked={onUpdateStatus(singleOrder.status = "REJECTED")}></input>
                        <input type="radio" value="Completed" name="completed" checked={onUpdateStatus(singleOrder.status = "REJECTED")}></input>
                        <input type="radio" value="Canceled" name="canceled" checked={onUpdateStatus(singleOrder.status = "REJECTED")}></input>
                        <input type="radio" value="Pending" name="pending" checked={onUpdateStatus(singleOrder.status = "REJECTED")}></input>
