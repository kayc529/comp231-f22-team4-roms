    ...
    <div className='control-main'>
        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                ...
                <div className="mb-3" onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} checked={orderStatus}>
                    <ToggleButton size="sm" inline height ="1" type={"radio"} label={"Accept"} id={"Accept"}value="ACCEPTED" name="radioStatus"/>
                    <ToggleButton inline type={"radio"} label={"Reject"} id={"Reject"} value="REJECTED" name="radioStatus" />
                    <ToggleButton inline type={"radio"} label={"Complete"} id={"Complete"} value="COMPLETED" name="radioStatus" />
                    <ToggleButton inline type={"radio"} label={"Cancel"} id={"Cancel"} value="CANCELED" name="radioStatus" />
                    <ToggleButton inline type={"radio"}label={"Pending"} id={"Pending"} value="PENDING" name="radioStatus"/>
                 </div>
            </h2>
