            ...
            <Table striped bordered hover variant="light">
                ...
                <tbody>   
                    {orderData.filter((order) => {
                        ...
                        else if (filterState == "today" && today.valueOf() == (moment(order.createdAt).format("YYYY-MM-DD").valueOf())) {
                        ...
                        else if (filterState == "past" && today.valueOf() > (moment(order.createdAt).format("YYYY-MM-DD").valueOf())) {
