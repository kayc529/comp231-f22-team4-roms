        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    <div onChange={(e) =>{setOrderStatus(e.target.value)}} >
                        ...
                        <input type="radio" value="Accepted" name="accepted" checked={onUpdateStatus(singleOrder, singleOrder.status = "ACCEPTED")}> Accept</input>
                        <input type="radio" value="Rejected" name="rejected" checked={onUpdateStatus(singleOrder, singleOrder.status = "REJECTED")}></input>
