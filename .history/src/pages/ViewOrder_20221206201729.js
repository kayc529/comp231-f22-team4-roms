    ...
    <div className='control-main'>
        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                ...
                <div className="mb-3" onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} defaultValue={singleOrder.status} defaultChecked={"Pending"}>
