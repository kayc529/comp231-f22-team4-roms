        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                ...
                <div onChange={(e) => { setOrderStatus(e.target.value); onUpdateStatus(singleOrder, e.target.value) }} defaultChecked={orderStatus}>
                    ...
                    <Form.Check inline type={"radio"} label={"Reject"} id={"Complete"} value="COMPLETED" name="radioStatus" />
                    <Form.Check inline type={"radio"} label={"Reject"} id={"Cancel"} value="CANCELED" name="radioStatus" />
                    <Form.Check inline type={"radio"}label={"Reject"} id={"Pending"} value="PENDING" name="radioStatus"/>
