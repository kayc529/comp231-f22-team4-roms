        ...
        <h2> Status: {orderStatus} </h2>
            ...
            />  */}
                    ...
                    <div onChange={(e) =>{setOrderStatus(e.target.value)}} >
                        ...
                        Accept  <input type="radio" value="Accepted" name="accepted" checked={onUpdateStatus(singleOrder, singleOrder.status = "ACCEPTED")}/> 
                        Reject <input type="radio" value="Rejected" name="rejected" checked={onUpdateStatus(singleOrder, singleOrder.status = "REJECTED")}></input>
                        Completed <input type="radio" value="Completed" name="completed" checked={onUpdateStatus(singleOrder, singleOrder.status = "COMPLETED")}></input>
                        Cancel <input type="radio" value="Canceled" name="canceled" checked={onUpdateStatus(singleOrder,singleOrder.status = "CANCELED")}></input>
                        Pending <input type="radio" value="Pending" name="pending" checked={onUpdateStatus(singleOrder,singleOrder.status = "PENDING")}></input>
