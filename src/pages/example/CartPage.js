...
const CartPage = () => {
    return (
      <div className="container">
        <div className="row">
            <div className="col-12" align="center" style={{backgroundColor:'black', color:'white', fontSize:'25px'}}><b>MY CART</b></div>
            <hr></hr>
            <br></br>
            ...
            <hr></hr>
            <div className="col-12" align="center" style={{backgroundColor:'black', color:'white', fontSize:'20px'}}>Select Pick-up Time (For Take-away Customers only)</div>
            ...
            <div className="col-12">&nbsp;</div>
            <div className="col-12">&nbsp;</div>
            <div className="col-12" align="center" style={{backgroundColor:'black', color:'white', fontSize:'20px'}}>Select Dine-in Time (For Dine-in Customers only)</div>
            <div className="col-12">&nbsp;</div>
            <div className="col-12" align="center">
